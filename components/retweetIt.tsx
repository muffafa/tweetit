...
function ReTweetItButton() {

  const tweetId = "1629455222425767939";
  
  const handleTweetClick = () => {
    const tweetUrl = `https://twitter.com/intent/retweet?tweet_id=${tweetId}`;
...
export default ReTweetItButton;
